 ...
 */
! function(e, t, n, o, r) { "function" == typeof define && define.amd ? define(function() { return e.fullpage = o(t, n), e.fullpage }) : "object" == typeof exports ? module.exports = o(t, n) : t.fullpage = o(t, n) }(this, window, document, function(Ut, _t) {
    "use strict";
    ...
    return Ut.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) { t = t || Ut; for (var n = 0; n < this.length; n++) e.call(t, this[n], n, this) }), Ut.fp_utils = {
            $: Rn,
            deepExtend: In,
            hasClass: zn,
            getWindowHeight: Bn,
        ...
        function(e, g) {
            ...
            if (!zn(Rn("html"), en)) {
                ...
                var f, v, p, h, A, L, M, T, O = kt(),
                    ...
                    R = !1;
                try {
                    var I = Object.defineProperty({}, "passive", { get: function() { R = !0 } });
                ...
                Dt(), Ut.fp_easings = In(Ut.fp_easings, { easeInOutCubic: function(e, t, n, o) { return (e /= o / 2) < 1 ? n / 2 * e * e * e + t : n / 2 * ((e -= 2) * e * e + 2) + t } }), y && (S.version = "3.0.5", S.setAutoScrolling = K, S.setRecordHistory = $, S.setScrollingSpeed = q, S.setFitToSection = ee, S.setLockAnchors = function(e) { g.lockAnchors = e }, S.setMouseWheelScrolling = te, S.setAllowScrolling = ne, S.setKeyboardScrolling = re, S.moveSectionUp = ie, S.moveSectionDown = le, S.silentMoveTo = ae, S.moveTo = se, S.moveSlideRight = ce, S.moveSlideLeft = ue, S.fitToSection = xe, S.reBuild = de, S.setResponsive = fe, S.getFullpageData = function() { return { options: g, internals: { container: y, canScroll: x, isScrollAllowed: d, getDestinationPosition: Ie, isTouch: i, c: Je, getXmovement: St, removeAnimation: ht, getTransforms: It, lazyLoad: De, addAnimation: pt, performHorizontalMove: dt, landscapeScroll: st, silentLandscapeScroll: Ht, keepSlidesPosition: Re, silentScroll: Rt, styleSlides: me, styleSection: be, scrollHandler: Ee, getEventsPage: Ct, getMSPointer: kt, isReallyTouch: Te, usingExtension: Nt, toggleControlArrows: ct, touchStartHandler: Oe, touchMoveHandler: Me } } }, S.destroy = function(e) {
                    ...
                    }), Bt(y), [un, En, yn].forEach(function(e) { Rn(e, y).forEach(function(e) { Jn(e) }) }), Ut.scrollTo(0, 0), [ln, gn, wn].forEach(function(e) { Fn(Rn("." + e), e) }))
                    ...
                    if (!g.anchors.length) {
                        ...
                        t.length && (N = !0, t.forEach(function(e) { g.anchors.push(e.getAttribute("data-anchor").toString()) }))
                    }
                    if (!g.navigationTooltips.length) {
                        var e = "[data-tooltip]",
                            n = Rn(g.sectionSelector.split(",").join(e + ",") + e, y);
                        n.length && n.forEach(function(e) { g.navigationTooltips.push(e.getAttribute("data-tooltip").toString()) })
                    }
                }(), function() {
                    ...
                    var l, a;
                    g.fixedElements && g.css3 && Rn(g.fixedElements).forEach(function(e) { m.appendChild(e) }), g.navigation && function() {
            ...
            function K(e, t) {
                ...
                var n = Rn(sn)[0];
                if (g.autoScrolling && !g.scrollBar) Nn(r, { overflow: "hidden", height: "100%" }), $(B.recordHistory, "internal"), Nn(y, { "-ms-touch-action": "none", "touch-action": "none" }), null != n && Rt(n.offsetTop);
                else if (Nn(r, { overflow: "visible", height: "initial" }), $(!!g.autoScrolling && B.recordHistory, "internal"), Nn(y, { "-ms-touch-action": "", "touch-action": "" }), Bt(y), null != n) {
            ...
            function ve(e) {
                ...
                t && Kn(t, pn + " a") ? function(e) {
                    ...
                    ze(Rn(an)[t])
                }.call(t, e) : io(t, ".fp-tooltip") ? function() { ro(Wn(this), "click") }.call(t) : io(t, Tn) ? function() {
                    var e = Kn(this, an);
                    ...
                    st(t, n)
                }.call(t, e) : Kn(t, g.menu + " [data-menuanchor]") && function(e) {!Rn(g.menu)[0] || !g.lockAnchors && g.anchors.length || (no(e), se(this.getAttribute("data-menuanchor"))) }.call(t, e)
            }
            ...
            function me(e, t, n) {
                ...
                }(e, n)), t.forEach(function(e) { Nn(e, { width: r + "%" }), g.verticalCentered && bt(e) });
                var c = Rn(Sn, e)[0];
            ...
            function ze(e, t, n) {
                if (null != e) {
                    ...
                    if (!(i.activeSection == e && !E || g.scrollBar && eo() === i.dtop && !zn(e, dn))) {
                        if (null != i.activeSlide && (o = i.activeSlide.getAttribute("data-anchor"), r = Xn(i.activeSlide)), !i.localIsResizing) { var l = i.yMovement; if (void 0 !== n && (l = n ? "up" : "down"), i.direction = l, oo(g.onLeave) && !1 === Be("onLeave", i)) return }
                        var a;
                        jt("parallax", "apply", i), jt("cards", "apply", i), g.autoScrolling && g.continuousVertical && void 0 !== i.isMovementUp && (!i.isMovementUp && "up" == i.yMovement || i.isMovementUp && "down" == i.yMovement) && ((s = i).isMovementUp ? qn(Rn(sn)[0], co(s.activeSection, an)) : $n(Rn(sn)[0], uo(s.activeSection, an).reverse()), Rt(Rn(sn)[0].offsetTop), Re(), s.wrapAroundElements = s.activeSection, s.dtop = s.element.offsetTop, s.yMovement = mt(s.element), s.leavingSection = Xn(s.activeSection, an) + 1, s.sectionIndex = Xn(s.element, an), ro(Rn(Jt)[0], "onContinuousVertical", s), i = s), Nt("scrollOverflowReset") && S.scrollOverflowReset.setPrevious(i.activeSection), i.localIsResizing || Ze(i.activeSection), g.scrollOverflow && g.scrollOverflowHandler.beforeLeave(), Gn(e, nn), Fn(to(e), nn), De(e), g.scrollOverflow && g.scrollOverflowHandler.onLeave(), x = S.test.isTesting, Lt(r, o, i.anchorLink, i.sectionIndex),
                            function(e) {
                                if (g.css3 && g.autoScrolling && !g.scrollBar) {
                                    ...
                                    wt(t, !0), g.scrollingSpeed ? (clearTimeout(p), p = setTimeout(function() { We(e) }, g.scrollingSpeed)) : We(e)
                                } else {
                                    var n = Pe(e.dtop);
                                    S.test.top = -e.dtop + "px", Xt(n.element, n.options, g.scrollingSpeed, function() { g.scrollBar ? setTimeout(function() { We(e) }, 30) : We(e) })
                                }
            ...
            function Fe(e) {
                ...
                function o(e) {
                    ...
                    return a = function(e) { for (var t, n = "", o = 0, r = 0, i = 0; o < e.length;)(r = e.charCodeAt(o)) < 128 ? (n += String.fromCharCode(r), o++) : 191 < r && r < 224 ? (i = e.charCodeAt(o + 1), n += String.fromCharCode((31 & r) << 6 | 63 & i), o += 2) : (i = e.charCodeAt(o + 1), t = e.charCodeAt(o + 2), n += String.fromCharCode((15 & r) << 12 | (63 & i) << 6 | 63 & t), o += 3); return n }(a)
                }

                function r(e) { return e.slice(3).slice(0, -3) }
                return function(e) { var t = e.split("_"); if (1 < t.length) { var n = t[1]; return e.replace(r(t[1]), "").split("_")[0] + "_" + o(n.slice(3).slice(0, -3)) } return r(e) }(o(e))
            }

            function Ue(e) {
                var t = function() { if (_t.domain.length) { for (var e = _t.domain.replace(/^(www\.)/, "").split("."); 2 < e.length;) e.shift(); return e.join(".").replace(/(^\.*)|(\.*$)/g, "") } return "" }(),
            ...
            function tt(e) {
                ...
                9 === n ? function(e) {
                    ...
                    function d(e) { return no(e), u[0] ? u[0].focus() : null }(t = e, n = it(_t), o = n.indexOf(_t.activeElement), r = t.shiftKey ? o - 1 : o + 1, i = n[r], l = je(Kn(i, mn)), a = Ne(Kn(i, an)), l || a) && (c ? null == Kn(c, sn + "," + sn + " " + Sn) && (c = d(e)) : d(e), (!s && c == u[u.length - 1] || s && c == u[0]) && no(e))
            ...
            function dt(e, t, n) {
                ...
                if (g.css3) {
                    ...
                    S.test.translate3dH[t.sectionIndex] = r, Nn(pt(Rn(En, e)), It(r)), h = setTimeout(function() { n && ut(t) }, g.scrollingSpeed)
            ...
            function ft() {
                if (ro(y, "onResize"), vt(), o) {
                    ...
                    if (!io(e, "textarea") && !io(e, "input") && !io(e, "select")) {
                        var t = Bn();
                        Math.abs(t - J) > 20 * Math.max(J, t) / 100 && (v = setTimeout(function() { de(!0), J = t }, navigator.userAgent.match("CriOS") ? 50 : 0))
                    }
                } else clearTimeout(v), v = setTimeout(function() { de(!0) }, 350)
            }
